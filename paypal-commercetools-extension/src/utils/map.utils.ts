...
export const mapCommercetoolsCarrierToPayPalCarrier = (
  ...
  return (
    CARRIERMAPPING[shippingCountry ?? 'GLOBAL'][carrier] ??
    CARRIERMAPPING['GLOBAL'][carrier] ??
    'OTHER'
  );
};
...
const CARRIERMAPPING: { [index: string]: any } = {
  GLOBAL: {
    ...
    'LBC EXPRESS INC.': 'LBCEXPRESS_FTP',
    ...
    'Metropolitan Warehouse & Delivery': 'MWD',
    Mhi: 'MHI',
